...
if __name__ == "__main__":
    ...
    mask, result = subtract_foreground("D:\SIMATS Engineering\ITA0513 Computer Vision\Practical\sources\ex1.jpg", lower_green, upper_green)

    cv2.imshow('Original', cv2.imread("D:\SIMATS Engineering\ITA0513 Computer Vision\Practical\sources\ex1.jpg"))
